    ...
    return (
        <header className="w-full shrink-0 z-50 bg-surface-bright border-b border-outline-variant">
                    ...
                    {!hideActions && (
                        <>
                            ...
                            <div ref={cajaRefD} className="relative">
                                ...
                                {cajaOpenD && (
                                    <CajaDropdown
                                        cajas={cajas} selectedCaja={selectedCaja}
                                        cajaForm={cajaForm} newCajaName={newCajaName}
                                        cajaError={cajaError} creating={creating}
            ...
            <div className="md:hidden h-[52px] flex items-center justify-between px-3 gap-2">
                ...
                {mobileView === 'products' ? (
                    /* Vista Productos: buscador + utilidades */
                    <>
                    ...
                    /* Vista Ticket: acciones + caja + serie + utilidades */
                    <>
...
/* ══════════════════════════════════════════════════════════════════════
   Sub-componentes reutilizables de dropdowns
══════════════════════════════════════════════════════════════════════ */
...
function CajaDropdown({ cajas, selectedCaja, cajaForm, newCajaName, cajaError, creating, onSelect, onShowForm, onNameChange, onCancel, onCreate }) {
    return (
        <div className="absolute left-0 top-full mt-1 w-60 bg-surface-container-lowest rounded-xl shadow-2xl border border-outline-variant/20 overflow-hidden z-[200]">
            {cajas.length === 0 ? (
